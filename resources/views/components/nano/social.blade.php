    ...
    <div class="nano-padding-inline">
        <center>
            ...
            <a href="{{ request()->getSchemeAndHttpHost() . '/social/dribbble' }}" class="nano-icon" target="_blank">
                <img src="https://raw.githubusercontent.com/atomjoy/icons/refs/heads/main/black/dribbble-40.png" alt="logo">
            </a>
            @endif
            ...
            <a href="{{ request()->getSchemeAndHttpHost() . '/social/pinterest' }}" class="nano-icon" target="_blank">
                <img src="https://raw.githubusercontent.com/atomjoy/icons/refs/heads/main/black/pinterest-40.png" alt="logo">
            </a>
            @endif
        </center>
    </div>
