<x-proton::row>
    <div class="nano-padding nano-bg nano-font-small">
        ...
        <div class="nano-p nano-font-small">This message was sent to email@example.com because you indicated that you are willing to stay up to date with news from Google. If you don't want to receive such emails in the future, please unsubscribe <a href="{{ request()->getSchemeAndHttpHost() . '/unsubscribe/email' }}" target="_blank">here</a>.</div>
    </div>
</x-proton::row>
